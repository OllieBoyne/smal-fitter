...
class SMAL(object):
    def __init__(self, model_path, data_path, opts, shape_family_id=-1, align=True, dtype=torch.float):
        self.opts = opts
        ...
        v_template = get_horse_template(model_path=model_path, data_path=data_path,
                                        shape_family_id = shape_family_id)

        # TODO modify this function to be more robust, and work with new v_template
        if align:
